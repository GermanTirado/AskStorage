...
namespace AskStorage.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Validación si el rol seleccionado es Admin y si lo es, lo agregamos
                    if (rol == CNT.Admin)
                    {
                    ...
                    //    $"Confirme su cuenta...<a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Haga click aquí</a>.");
